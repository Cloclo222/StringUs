...
void Scara::init_moteur()
{
    ...
    _dxl.writeControlTableItem(MIN_POSITION_LIMIT, moteur_droit, limit_moteur_droit[0]);
    _dxl.writeControlTableItem(MAX_POSITION_LIMIT, moteur_droit, limit_moteur_droit[1]);
